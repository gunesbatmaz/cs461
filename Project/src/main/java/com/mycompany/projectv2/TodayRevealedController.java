...
import static com.mycompany.projectv2.TodayController.d;
...
public class TodayRevealedController implements Initializable{
    ...
    private final String[][] puzzle = TodayController.puzzle;
    private final String[][] nums = TodayController.nums;
    private String[][] c = TodayController.c;
    private final String d = TodayController.d;
        ...
        RevealButton.setOnAction(new EventHandler<ActionEvent>() {
            @Override public void handle(ActionEvent e) {
                ...
                do{
                    ...
                    try{
                        ArrayList<String> tryanswers = PathToFollow.decidePath(areaList,isToday,puzzle,nums,c, true);
                ...
                }while(!flag && PathToFollow.count < 5);
