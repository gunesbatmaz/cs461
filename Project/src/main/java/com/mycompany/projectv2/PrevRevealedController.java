...
public class PrevRevealedController implements Initializable{
    ...
    private String[][] puzzle = PrevController.puzzle;
    private String[][] nums = PrevController.nums;
    private String[][] c = PrevController.c;
    private String d = PrevController.d;
